...
function getCaretCoordinates(element, position, options) {
  ...
  /**
   * Here have modified
   * top: span.offsetTop-element.scrollTop + parseInt(computed['borderTopWidth']) ,
   * left: span.offsetLeft-element.scrollLeft + parseInt(computed['borderLeftWidth']),
   */
  let coordinates = {
    top: span.offsetTop-element.scrollTop + parseInt(computed['borderTopWidth']) ,
    left: span.offsetLeft-element.scrollLeft + parseInt(computed['borderLeftWidth']),
